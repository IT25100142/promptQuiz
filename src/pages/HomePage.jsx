...
export default function HomePage() {
  ...
  return (
    <div className="flex-1">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-teal-50 dark:from-teal-950/40 via-white dark:via-slate-900 to-cyan-50 dark:to-cyan-950/40 rounded-3xl mx-4 mt-8 mb-12 shadow-xl border border-slate-100 dark:border-slate-800/80 transition-colors duration-250">
        <div className="absolute inset-0 bg-gradient-to-r from-teal-400/10 to-cyan-400/10"></div>
        <div className="relative px-8 py-16 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-teal-100 dark:bg-teal-950/50 text-teal-700 dark:text-teal-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link
                to="/decks"
                className="group inline-flex items-center gap-3 bg-white dark:bg-slate-850 text-slate-700 dark:text-slate-200 px-8 py-4 rounded-2xl font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 border border-slate-200 dark:border-slate-700"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                <span>My Decks</span>
                <div className="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-1 rounded-full text-xs font-semibold">
                  {savedDecks.length}
                </div>
              </Link>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="group bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-slate-100 dark:border-slate-800/80">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-4">AI-Powered Creation</h3>
          ...
          <div className="group bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-slate-100 dark:border-slate-800/80">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-4">Spaced Repetition</h3>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      {savedDecks.length > 0 && (
        <div className="max-w-4xl mx-auto px-4 mb-12">
          <div className="bg-gradient-to-r from-slate-50 dark:from-slate-900 to-slate-100 dark:to-slate-900/60 rounded-2xl p-8 border border-slate-200 dark:border-slate-800">
            <h3 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-6 text-center">Your Learning Progress</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-teal-600 dark:text-teal-400 mb-2">{savedDecks.length}</div>
                <div className="text-slate-600 dark:text-slate-400">Total Decks</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 dark:text-slate-400">Learning Potential</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-3xl p-12 text-center text-white shadow-2xl">
          ...
          <Link
            to="/create"
            className="inline-flex items-center gap-3 bg-white dark:bg-slate-850 text-teal-600 dark:text-teal-300 px-8 py-4 rounded-2xl font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
